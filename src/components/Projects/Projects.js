...
import video1 from "../../Assets/Projects/video.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="This project analyzes slot machine gameplay using computer vision. A ResNet-18 model classifies video frames into idle, spinning, or winning states. YOLOv8 detects UI elements like bet amounts, cash, and winnings, while PaddleOCR extracts numeric values from these regions. The system logs gameplay events and exports structured data for large-scale analysis."             
            />
          </Col>
        </Row>
      </Container>
